              ...
              {!isSignUp && (
                <>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <Button variant="outline" type="button" onClick={() => handleOAuth('azure')} className="bg-transparent border-white/10 text-white hover:bg-white/5 hover:border-[#00a4ef]/50 transition-colors">
                      <svg viewBox="0 0 24 24" className="w-4 h-4 mr-2" fill="currentColor">
