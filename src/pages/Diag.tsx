...
// The claims we actually read off the decoded Supabase JWT. Kept as an open
// record so unexpected/extra claims don't break decoding.
type JwtClaims = {
  sub?: string;
  email?: string;
  app_role?: string;
...
// The subset of the profiles row this diagnostic selects and displays.
type ProfileRow = {
  id: string;
  role: string | null;
  status: string | null;
...
export default function Diag() {
  ...
  const [decoded, setDecoded] = useState<JwtClaims | null>(null);
